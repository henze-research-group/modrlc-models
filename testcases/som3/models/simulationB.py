...
def run(plot=True, customized_kpi_config=None):
    ...
    if plot:
        ...
        plt.plot(time, loSet, '--', label='Lower setpoint')
        plt.plot(time, hiSet, '--', label='Upper setpoint')
        plt.ylabel('Temperature [C]')
