  ...
  Buildings.Fluid.Sources.Outside Outside(redeclare final package Medium = Medium,
    ...
    model ASHRAESystem3 "PZS-AC Constant Air Volume Packaged Single Zone Rooftop Unit"
      ...
      model System3RBControls "Rule-Based controls replicating those of the DOE Ref. Small Office Building"
        ...
        Buildings.Controls.OBC.CDL.Continuous.Greater gre(h=0.01, pre_y_start=
              true)
          annotation (Placement(transformation(extent={{274,220},{294,240}})));
        Modelica.Blocks.Sources.RealExpression fanSetpointOccupied3(y=0.02)
          annotation (Placement(transformation(extent={{190,214},{210,234}})));
        ...
        Buildings.Controls.Continuous.LimPID conPID(
          ...
          y_reset=0)
          annotation (Placement(transformation(extent={{42,300},{62,320}})));
        Buildings.Controls.OBC.CDL.Continuous.Less les(h=1, pre_y_start=true)
          annotation (Placement(transformation(extent={{-52,236},{-32,256}})));
        Buildings.Controls.Continuous.LimPID damPID(
          ...
          y_reset=0) annotation (Placement(transformation(extent={{250,-206},{
                  270,-186}})));
      ...
      equation
        ...
        //Setpoints - General//
        //Modelica.Utilities.Streams.print("x = " + String(lim.y));
      ...
      connect(pre1.y,OASetpoint. u2)
        ...
        connect(gre.u2, fanSetpointOccupied3.y) annotation (Line(points={{272,222},
                {270,222},{270,224},{211,224}},
                                           color={0,0,127}));
        connect(gre.y, or1.u1) annotation (Line(points={{296,230},{310,230},{
                310,162},{322,162}},
                            color={255,0,255}));
        ...
        connect(or3.u1, pre1.u) annotation (Line(points={{354,92},{348,132},{
                348,-170},{38,-170},{38,-194},{48,-194}}, color={255,0,255}));
        connect(or3.u2, cooSetpoint.u2) annotation (Line(points={{354,84},{32,
                84},{32,68},{-296,68},{-296,142},{-280,142},{-280,202},{-224,
                202}}, color={255,0,255}));
        ...
        connect(les.u2, oveHeaSetpoint.y) annotation (Line(points={{-54,238},{
                -64,238},{-64,248},{-165,248}}, color={0,0,127}));
        connect(les.y, conPID.trigger) annotation (Line(points={{-30,246},{7,
                246},{7,298},{44,298}}, color={255,0,255}));
        connect(damPID.u_s, OASetpoint.y) annotation (Line(points={{248,-196},{
                200,-196},{200,-194},{150,-194}}, color={0,0,127}));
        connect(damPID.u_m, senDamVFR) annotation (Line(points={{260,-208},{
                -184,-208},{-184,-184},{-630,-184}}, color={0,0,127}));
        connect(damPID.y, outDamSet) annotation (Line(points={{271,-196},{615.5,
                -196},{615.5,143},{681,143}}, color={0,0,127}));
        connect(fanPID.u_s, fanSetLinear.y) annotation (Line(points={{472,122},
                {442,122},{442,118},{416,118}}, color={0,0,127}));
        connect(fanPID.y, outFanSet) annotation (Line(points={{495,122},{582,
                122},{582,251},{679,251}}, color={0,0,127}));
        connect(fanPID.u_m, senFanVFR) annotation (Line(points={{484,110},{488,
      ...
      dpDamExh_nominal=3,
      dpDamOut_nominal=3,
        dpDamRec_nominal=3)        "Economizer: mixing box with damper"
      ...
      Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.SingleSpeed sinSpeDX(
        ...
        annotation (Placement(transformation(extent={{-96,-114},{-38,-56}})));
    ...
    connect(mixDam.port_Sup, sinSpeDX.port_a) annotation (Line(points={{-212,
              -200.4},{-200,-200.4},{-200,-85},{-96,-85}},
                                               color={0,127,255}));
      connect(sinSpeDX.port_b, hea.port_a)
        annotation (Line(points={{-38,-85},{80,-85}},          color={0,127,255}));
    ...
    connect(cooPowDem, sinSpeDX.P) annotation (Line(points={{464,122},{22,122},
              {22,-58.9},{-35.1,-58.9}},
                                      color={0,0,127}));
...
equation
  ...
  connect(weaBus.TDryBul, HVAC.senTemOA) annotation (Line(
    ...
    connect(corZon.TAir, HVAC.temSenRet) annotation (Line(points={{95,102},{
            31.5,102},{31.5,24.625},{-33.014,24.625}},
                                                   color={0,0,127}));
    ...
    connect(HVAC1.zonRetPor, perZon1.ports[2]) annotation (Line(points={{-28.8,
            ...
            255}));
    connect(perZon1.TAir, HVAC1.temSenRet) annotation (Line(points={{95,-56},{
            100,-56},{100,-52},{-31.014,-52},{-31.014,-55.375}},    color={0,0,
            127}));
    connect(perZon2.TAir, HVAC2.temSenRet) annotation (Line(points={{95,-146},{
            102,-146},{102,-140},{-12,-140},{-12,-145.375},{-31.014,-145.375}},
          color={0,0,127}));
    connect(perZon3.TAir, HVAC3.temSenRet) annotation (Line(points={{93,-236},{
            102,-236},{102,-226},{-4,-226},{-4,-233.375},{-33.014,-233.375}},
          color={0,0,127}));
    connect(perZon4.TAir, HVAC4.temSenRet) annotation (Line(points={{93,-314},{
            102,-314},{102,-304},{2,-304},{2,-311.375},{-31.014,-311.375}},
          color={0,0,127}));
